...
public class FragmentProgress extends Fragment implements AdapterPemesanan.onSelected {
...
//                            SweetDialogs.commonInvalidToken(getActivity() ,"Gagal Memuat Permintaan" ,response.body().getmRm());
    ...
    void onDataReady(List<PesananModel> model){
        ...
        adapter = new AdapterPemesanan(getActivity(), model, FragmentProgress.this);
