...
public class AdapterHistoryOrderCustomer extends RecyclerView.Adapter<AdapterHistoryOrderCustomer.ViewHolder> {
    ...
    public AdapterHistoryOrderCustomer(Context context, List<PesananModel> models ) {
    ...
    @NonNull
    @Override
    public AdapterHistoryOrderCustomer.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
