...
public class AdapterHistoryOrderDriver extends RecyclerView.Adapter<AdapterHistoryOrderDriver.ViewHolder> {
    ...
    public AdapterHistoryOrderDriver(Context context, List<PesananModel> models ) {
